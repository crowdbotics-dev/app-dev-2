"""
Django settings for app_dev_2 project.
...
WSGI_APPLICATION = 'app_dev_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "app_dev_2 API",
    "DESCRIPTION": "API documentation for app_dev_2 App",
    "VERSION": "v1",
}
